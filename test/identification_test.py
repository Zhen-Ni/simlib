...
def test_identification_frequency_domain_continuous():
    ...
    system1 = identification_frequency_domain_continuous(
        freq, mag0 * exp(1j * phase0), m, n, weight='h')
...
def test_identification_frequency_domain_discrete():
    ...
    system1 = identification_frequency_domain_discrete(
        freq, mag0 * exp(1j * phase0), 1 / FS, m, n, weight='h')
